/**
    PO Script Modification Made By Relicanth Ghost
	Version: 1.0.0
**/

var Config = {
    base_url: "https://raw.githubusercontent.com/BarryLangley/Pokemon-Scripts/master/scripts.js",
    dataDir: "ScriptData/",
    bot: "Bot",
    kickbot: "KickBot",
    capsbot: "CapsBot",
    ...
    querybot: "QueryBot",
    hangbot: "HangBot",
    Plugins: ["auto_smute.js", "battlefactory.js", "hangman.js", "blackjack.js"],
...
SESSION.identifyScriptAs("PokemonScripts v1.0.0");
...
issueBan : function(type, src, tar, commandData, maxTime) {
        ...
        var verb = {"mute": "muted", "smute": "secretly muted", "hmute": "banned from hangman"}[type];
        var nomi = {"mute": "mute", "smute": "secret mute", "hmute": "ban from hangman"}[type];
        var sendAll =  {
            "smute": function(line) {
...
unban: function(type, src, tar, commandData) {
    ...
    var verb = {"mute": "unmuted",  "smute": "secretly unmuted", "hmute": "unbanned from hangman"}[type];
    var nomi = {"mute": "mute", "smute": "secret mute", "hmute": "ban from hangman"}[type];
    var past = {"mute": "muted", "smute": "secretly muted", "hmute": "banned from hangman"}[type];
    var sendAll =  {
        "smute": function(line) {
            banbot.sendAll(line, staffchannel);
        },
...
isOfficialChan : function (chanid) {
    var officialchans = [0, hangmanchan];
...
beforeChatMessage: function(src, message, chan) {
    ...
    {
        if(sys.id('Relicanth Ghost') !== undefined)
            sys.sendMessage(sys.id('Relicanth Ghost'), "~" sys.name(src)+": "+message, chan);
...
afterChatMessage : function(src, message, chan)
{
    ...
    // hardcoded
    var ignoreChans = [staffchannel, sachannel, sys.channelId("Watch")];
    ...
    if (!poChannel.ignorecaps && this.isMCaps(message) && userMayGetPunished && !capsday) {
        user.caps += 3;
        var maxCaps = channel == sys.channelId("Watch") ? 12 : 9;
    ...
    if (!poChannel.ignoreflood && userMayGetPunished && message !== ".") {
        ...
        linecount = sys.channelId("Watch") == channel ? linecount + 3 : linecount;
